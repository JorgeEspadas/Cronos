<html lang="es">
    ...
    <body>
        <div class="container">
            ...
            <form class="form-horizontal" method="POST" action="guardar_alumno.php" autocomplete="off">
                ...
                <div class="form-group">
                    <label for="matricula" class="col-sm-2 control-label">Matricula</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="matricula" name="matricula" maxlength="5" placeholder="matricula" required pattern="[0-9]+">
                        </div>
                </div>
			...
			<div class="col-sm-10">
                            <input type="number" class="form-control" id="horario" min="1" max="2" name="horario" placeholder="Horario" required >
			</div>
                </div>
